...
var event = exports.event = 'plugin:pet:giveitem';
var description = exports.description = 'Give your pet an item from your equipment.';
var args = exports.args = 'itemId';
var socket = exports.socket = function socket(_socket, primus, respond) {

  var petgiveitem = function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:Give', playerName + ' (' + _socket.address.ip + ') giving ' + itemId + ' to pet.');
    ...
    return function petgiveitem(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, petgiveitem);
};