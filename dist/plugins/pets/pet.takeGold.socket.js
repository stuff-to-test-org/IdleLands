...
var event = exports.event = 'plugin:pet:takegold';
var description = exports.description = 'Take your pets gold.';
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:TakeGold', playerName + ' (' + _socket.address.ip + ') pet gold taking.');
