...
var event = exports.event = 'plugin:pet:smart';
var description = exports.description = 'Toggle a smart pet setting.';
var args = exports.args = 'setting';
var socket = exports.socket = function socket(_socket) {

  var petsmart = function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:Smart', playerName + ' (' + _socket.address.ip + ') pet smart toggle ' + setting + '.');
    ...
    return function petsmart(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, petsmart);
};