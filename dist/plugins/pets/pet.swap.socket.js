...
var event = exports.event = 'plugin:pet:swap';
var description = exports.description = 'Swap to a different pet.';
var args = exports.args = 'petType';
var socket = exports.socket = function socket(_socket) {

  var swappet = function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:Swap', playerName + ' (' + _socket.address.ip + ') pet swapping to ' + petType + '.');
    ...
    return function swappet(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, swappet);
};