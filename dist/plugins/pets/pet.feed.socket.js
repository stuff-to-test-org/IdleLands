...
var event = exports.event = 'plugin:pet:feed';
var description = exports.description = 'Feed your pet gold.';
var args = exports.args = 'gold';
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:Feed', playerName + ' (' + _socket.address.ip + ') feeding pet ' + gold + ' gold.');
