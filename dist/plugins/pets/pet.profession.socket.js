...
var event = exports.event = 'plugin:pet:profession';
var description = exports.description = 'Change your pets profession.';
var args = exports.args = 'newProfession';
var socket = exports.socket = function socket(_socket) {

  var petclass = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(_ref2) {
      var newProfession = _ref2.newProfession;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:Profession', playerName + ' (' + _socket.address.ip + ') pet profession change to ' + newProfession + '.');
    ...
    return function petclass(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, petclass);
};