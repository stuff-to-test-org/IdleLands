...
var event = exports.event = 'plugin:pet:attr';
var description = exports.description = 'Change your pets attribute.';
var args = exports.args = 'newAttr';
var socket = exports.socket = function socket(_socket) {

  var petattr = function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:AttributeChange', playerName + ' (' + _socket.address.ip + ') changing pet attribute to ' + newAttr);
    ...
    return function petattr(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, petattr);
};