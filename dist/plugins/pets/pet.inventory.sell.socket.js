...
var event = exports.event = 'plugin:pet:sell';
var description = exports.description = 'Sell an item from your pets inventory.';
var args = exports.args = 'itemId';
var socket = exports.socket = function socket(_socket) {

  var petsell = function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:Sell', playerName + ' (' + _socket.address.ip + ') pet selling ' + itemId + '.');
    ...
    return function petsell(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, petsell);
};