...
var event = exports.event = 'plugin:pet:upgrade';
var description = exports.description = 'Upgrade a facet of your pet.';
var args = exports.args = 'upgradeAttr';
var socket = exports.socket = function socket(_socket) {

  var upgrade = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(_ref2) {
      var upgradeAttr = _ref2.upgradeAttr;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:Upgrade', playerName + ' (' + _socket.address.ip + ') pet upgrade ' + upgradeAttr + '.');
