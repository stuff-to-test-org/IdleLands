...
var event = exports.event = 'plugin:pet:takeitem';
var description = exports.description = 'Take an item from your pet and equip it.';
var args = exports.args = 'itemId';
var socket = exports.socket = function socket(_socket, primus, respond) {

  var pettakeitem = function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Pet:Take', playerName + ' (' + _socket.address.ip + ') taking ' + itemId + ' from pet.');
    ...
    return function pettakeitem(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, pettakeitem);
};