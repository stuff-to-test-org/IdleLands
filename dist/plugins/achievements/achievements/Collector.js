...
var Collector = exports.Collector = function (_Achievement) {
  _inherits(Collector, _Achievement);

  function Collector() {
    _classCallCheck(this, Collector);

    return _possibleConstructorReturn(this, (Collector.__proto__ || Object.getPrototypeOf(Collector)).apply(this, arguments));
  }
