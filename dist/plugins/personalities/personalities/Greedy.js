...
var Greedy = exports.Greedy = (_temp = _class = function (_Personality) {
  ...
  _createClass(Greedy, null, [{
    ...
    value: function disable(player) {
      _get(Greedy.__proto__ || Object.getPrototypeOf(Greedy), 'disable', this).call(this, player);
      this.flagDirty(player, ['xp', 'gold']);
    }
  }, {
    key: 'enable',
    value: function enable(player) {
      _get(Greedy.__proto__ || Object.getPrototypeOf(Greedy), 'enable', this).call(this, player);
      this.flagDirty(player, ['xp', 'gold']);
    }
  }, {
    key: 'hasEarned',
