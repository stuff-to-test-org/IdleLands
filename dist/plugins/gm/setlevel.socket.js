...
var event = exports.event = 'plugin:gm:setlevel';
var description = exports.description = 'Mod only. Set a players level.';
var args = exports.args = 'targetName, targetLevel';
var socket = exports.socket = function socket(_socket) {

  var setlevel = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(_ref2) {
      var targetName = _ref2.targetName,
          targetLevel = _ref2.targetLevel;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              _logger.Logger.info('Socket:GM:SetLevel', playerName + ' (' + _socket.address.ip + ') setting level ' + targetLevel + ' on ' + targetName + '.');

              target = _gameState.GameState.getInstance().getPlayer(targetName);

              _commands.GMCommands.setLevel(target, targetLevel);
