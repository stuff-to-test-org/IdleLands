...
var RelentlessAssault = exports.RelentlessAssault = function (_Effect) {
  _inherits(RelentlessAssault, _Effect);
  ...
  _createClass(RelentlessAssault, [{
    key: 'tick',
    value: function tick() {
      _get(RelentlessAssault.prototype.__proto__ || Object.getPrototypeOf(RelentlessAssault.prototype), 'tick', this).call(this);
