...
var Frostbite = exports.Frostbite = function (_Effect) {
  _inherits(Frostbite, _Effect);
  ...
  _createClass(Frostbite, [{
    ...
    key: 'tick',
    value: function tick() {
      _get(Frostbite.prototype.__proto__ || Object.getPrototypeOf(Frostbite.prototype), 'tick', this).call(this);
      this.stun = _effect.Effect.chance.bool({ likelihood: this.potency });
      this.stunMessage = this.target.fullname + ' is frostbitten!';
    }
  }]);
