...
exports.ProfessionChange = exports.WEIGHT = undefined;
...
var ProfessionChange = exports.ProfessionChange = (_temp = _class = function (_Event) {
  _inherits(ProfessionChange, _Event);

  function ProfessionChange() {
    _classCallCheck(this, ProfessionChange);

    return _possibleConstructorReturn(this, (ProfessionChange.__proto__ || Object.getPrototypeOf(ProfessionChange)).apply(this, arguments));
  }

  _createClass(ProfessionChange, null, [{
    key: 'operateOn',
    value: function operateOn(player, _ref) {
      var professionName = _ref.professionName,
          trainerName = _ref.trainerName;

      var otherOfSame = _lodash2.default.find(player.choices, function (choice) {
        return choice.event === 'ProfessionChange';
      });
    ...
    value: function makeChoice(player, id, response) {
      ...
      _emitter.emitter.emit('player:changeclass', { player: player, choice: choice });
    }
  }]);
