...
var event = exports.event = 'plugin:player:request:statistics';
var description = exports.description = 'Request statistics data. Generally used only when looking at statistics.';
...
var socket = exports.socket = function socket(_socket) {
  ...
  var requeststatistics = function () {
    ...
    return function requeststatistics() {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, requeststatistics);
};