...
var event = exports.event = 'plugin:player:changegender';
var description = exports.description = 'Change your gender based on the existing gender list.';
var args = exports.args = 'gender';
var socket = exports.socket = function socket(_socket) {
  ...
  var changegender = function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _logger.Logger.info('Socket:Player:Gender', playerName + ' (' + _socket.address.ip + ') changing gender to ' + gender + '.');
    ...
    return function changegender(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, changegender);
};