...
var event = exports.event = 'plugin:player:request:achievements';
var description = exports.description = 'Request achievement data. Generally used only when looking at achievements.';
var args = exports.args = '';
var socket = exports.socket = function socket(_socket) {

  var requestachievements = function () {
    ...
    return function requestachievements() {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, requestachievements);
};