...
var event = exports.event = 'plugin:player:request:collectibles';
var description = exports.description = 'Request collectible data. Generally used only when looking at collectibles.';
var args = exports.args = '';
var socket = exports.socket = function socket(_socket) {

  var requestcollectibles = function () {
    ...
    return function requestcollectibles() {
      return _ref.apply(this, arguments);
    };
  }();

  _socket.on(event, requestcollectibles);
};