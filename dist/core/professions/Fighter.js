...
var Fighter = exports.Fighter = (_temp = _class = function (_Profession) {
  ...
  return Fighter;
}(_profession.Profession), _class.baseHpPerLevel = _profession.Profession.baseHpPerLevel + 150, _class.baseMpPerLevel = _profession.Profession.baseMpPerLevel + 18, _class.baseMpPerStr = 6, _class.baseMpPerInt = 6, _class.baseConPerLevel = 2, _class.baseDexPerLevel = 4, _class.baseAgiPerLevel = 3, _class.baseStrPerLevel = 5, _class.baseIntPerLevel = 1, _class.classStats = {
